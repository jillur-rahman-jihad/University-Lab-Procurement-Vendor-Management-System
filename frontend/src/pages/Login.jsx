      ...
      <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-xl shadow-lg border border-gray-100">
        <div>
          <div className="flex justify-center mb-4">
            <span className="material-icons text-4xl text-blue-600">login</span>
          </div>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleLogin}>
          ...
          <div className="rounded-md shadow-sm -space-y-px">
            <div className="mb-4 relative">
              ...
              <span className="material-icons absolute left-3 top-3 text-gray-400" style={{ fontSize: '20px' }}>email</span>
              <input
                id="email-address"
                name="email"
                type="email"
            ...
            <div className="relative">
              ...
              <span className="material-icons absolute left-3 top-3 text-gray-400" style={{ fontSize: '20px' }}>lock</span>
              <input
                id="password"
                name="password"
                type="password"
